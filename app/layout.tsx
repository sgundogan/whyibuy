...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        {/* Microsoft Clarity — session recordings + heatmaps. Free, GDPR-safe,
            defaults to masking sensitive text. Project id is public (visible in
            every recorded session) so inlining is fine — not a secret. */}
        <Script
          id="clarity-script"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
...
})(window,document,"clarity","script","xrxtoaqzqy");`,
          }}
        />
      </head>
